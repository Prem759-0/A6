...
export const PRODUCTS: Product[] = [
  ...
  {
    id: "prod-10",
    name: "Pure Ceremonial Stone-ground Matcha Jar",
    category: "latte-mix",
    ...
    price: 29.95,
    isFromPrice: false,
    description: "Direct from Uji, Japan. A luxurious artisanal ceremonial matcha stone-ground to an ultra-fine velveteen green powder that whisks into a vibrant emerald froth.",
    image: "matcha-canister",
    bgGradient: "from-[#E8F5E9] to-[#C8E6C9]"
  },
  {
    id: "prod-11",
    name: "Organic Jasmine Green Dragon Pearls",
    category: "tea-sachets",
    badgeText: "TEA JARS",
    ...
    price: 18.95,
    isFromPrice: true,
    description: "Delicate spring-harvested organic green tea leaves scented with sweet nighttime jasmine blooms, hand-rolled into tiny dragon pearls.",
    image: "jasmine-pearls",
    bgGradient: "from-[#F3E5F5] to-[#E1BEE7]"
  },
  {
    id: "prod-12",
    name: "Organic Royal Golden Earl Grey Imperial",
    category: "tea-sachets",
    badgeText: "TEA SACHETS",
    ...
    price: 12.50,
    isFromPrice: false,
    description: "A robust organic black tea blended with real oil of Mediterranean Bergamot and strewn with royal blue cornflower blossoms.",
    image: "earl-grey",
    bgGradient: "from-[#E3F2FD] to-[#BBDEFB]"
  },
  {
    id: "prod-13",
    name: "Cold Brew Hibiscus Breeze Pouches",
    category: "naked-sachets",
    badgeText: "ICED TEA",
    ...
    price: 14.95,
    isFromPrice: true,
    description: "Our refreshing, caffeine-free ruby red hibiscus flowers blended with dried rosehips, orange peel, and natural sweet berries for simple overnight cold brewing.",
    image: "iced-pouches",
    bgGradient: "from-[#FCE4EC] to-[#F8BBD0]"
  },
  {
    id: "prod-14",
    name: "Organic Chamomile Serene Dreams Box",
    category: "tea-sachets",
    badgeText: "TEA SACHETS",
    badgeColor: "bg-[#8BC34A]",
    badgeTextColor: "text-white",
    ...
    price: 11.95,
    isFromPrice: false,
    description: "Sourced from high alpine fields, our botanical chamomile flowers release a sweet apple-like aroma to naturally soothe you directly into serene sleep.",
    image: "chamomile-serene",
    bgGradient: "from-[#FFFDE7] to-[#FFF9C4]"
  },
  {
    id: "prod-15",
    name: "Sweet Peach Blossom Garden",
    category: "gifts-samplers",
    badgeText: "GIFTS & SAMPLERS",
    badgeColor: "bg-[#FF8A65]",
    badgeTextColor: "text-neutral-900",
    rating: 4.92,
    reviewCount: 104,
    price: 22.50,
    isFromPrice: false,
    description: "A delicious sweet blend of orchard-fresh peaches, dried organic apples, hibiscus petals, and golden calendula blooms packed in a deluxe custom tin.",
    image: "peach-blossom",
    bgGradient: "from-[#FFE0B2] to-[#FFCC80]"
  }
];
